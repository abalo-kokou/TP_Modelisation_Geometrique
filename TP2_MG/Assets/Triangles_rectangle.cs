...
public class Triangles_rectangle : MonoBehaviour
{
    public Material mat;
    ...
    void Start()
    {
        ...
        int[] triangles = new int[6];                   // car on a 3 sommets + 3 sommets (pour les deux triangles) 


        vertices[0] = new Vector3(0, 0, 0);               // Remplissage de la structure sommet vertices[0] = new Vector3(0, 0, 1);
